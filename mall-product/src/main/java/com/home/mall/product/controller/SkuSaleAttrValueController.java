...
public class SkuSaleAttrValueController {
    ...
    @GetMapping(value = "/getSaleAttrList/{skuId}")
    public List<String> getProductAttributesList(@PathVariable("skuId")Long skuId){
        return skuSaleAttrValueService.getProductAttributesList(skuId);
    }
